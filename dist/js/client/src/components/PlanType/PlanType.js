...
require("./plantype.css");
const PlanType = ({ toggleShowPlanType }) => {
    react_1.default.useEffect(() => {
        document.body.classList.remove('collapsed-active');
    }, []);
    return (<>
      <div className="hp-main-layout-content">
        <button className="planType-modal_close ml-auto" aria-label="close" onClick={toggleShowPlanType}>
            ...
            <div className="pricing-grid">
              ...
              <div className="pricing-top">
                ...
                <div className="pricing-top-wrap">
                  ...
                  <div className="pricing-small-text">Credits</div>
                  <a href="/" className="primary-button btn-primary w-inline-block is-disabled">
                    <div className="button-text-wrap">
