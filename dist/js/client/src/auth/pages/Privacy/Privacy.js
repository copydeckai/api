...
const Privacy = () => {
    ...
    return (<>
      <WindowTitle_1.WindowTitle title={`Privacy Policy`}/>
      <div className="section">
        <div className="container">
          <div className="text-container center _37-5rem xl-margin">
            <h1 className="h1-title s-margin">Privacy policy</h1>
          ...
          <div className="rich-text-2 w-richtext">
            <p>
              At Copydeck, accessible at copydeck.ai, one of our main priorities is the privacy of
            ...
            <p>
              ...
              <a href="mailto:email@copydeck.ai"> email@copydeck.ai</a>.
            </p>
            <p>
              ...
              Name. This policy is not applicable to any information collected offline or via
            ...
            <p>
              ...
              items such as name, Copydeck, address, email address, and telephone number.
            </p>
            ...
            <p>
              ...
              Website Name, which are sent directly to users' browser. They automatically receive
            ...
            <p>
              Note that Website Name has no access to or control over these cookies that are used by
            ...
            <p>
              Website Name does not knowingly collect any Personal Identifiable Information from
