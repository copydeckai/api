...
const completion = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        if (req.method !== "POST")
            return next((0, error_1.createError)(405, "Only POST requests allowed"));
        const body = req.body;
        const completion = yield openai.createCompletion(body);
...
const edit = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        if (req.method !== "POST")
            return next((0, error_1.createError)(405, "Only POST requests allowed"));
        const body = req.body;
        const edit = yield openai.createEdit(body);
...
const embedding = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        if (req.method !== "POST")
            return next((0, error_1.createError)(405, "Only POST requests allowed"));
        const body = req.body;
        const completion = yield openai.createEmbedding(body);
        res.status(200).json(completion.data);
    }
    catch (err) {
        next(err);
